...
from strategy_simulator.test_back.comet.utils import dummy_func, convert_int_to_date
from strategy_simulator.test_back.comet.analyser.data_proxy import LocalDataProxy
from strategy_simulator.test_back.comet.simulator.scheduler import Scheduler
from strategy_simulator.test_back.comet.simulator.trade_param import TradeSimulationParams
from strategy_simulator.test_back.comet.simulator.trade_executor import TradeSimulationExecutor

from utils.logger import bt_log
from utils.logger import bt_user_print
from utils.common import get_project_root

from strategy_simulator.test_back.comet import api
...
DEFAULT_DATA_BUNDLE_PATH = ('%s/strategy_simulator/test_back/comet/data_bundle/data' % get_project_root())
DEFAULT_DATA_BUNDLE_TMP_PATH = ('%s/strategy_simulator/test_back/comet/data_bundle/tmp' % get_project_root())
DEFAULT_STRATEGY_PATH = ('%s/strategy_simulator/test_back/comet/strategy' % get_project_root())
DEFAULT_RESULT_PATH = ('%s/strategy_simulator/test_back/comet/result' % get_project_root())
DEFAULT_RESOURCE_PATH = ('%s/strategy_simulator/test_back/comet/resource' % get_project_root())
